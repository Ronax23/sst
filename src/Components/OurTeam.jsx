            ...
            <section ref={sectionRef} id="OurTeam">
                <div className="container-fluid sticky-box overflow-hidden">
                    <div ref={trackRef} className="horizontal-scroll-track d-flex flex-nowrap">
                        {team.map((member, i) => (
                            <div key={i} className="col-12 col-lg-6 flex-shrink-0">
                                <div className="cards">
                                    <div className="team-member text-center p-4">
                                        <div className="row">
                                            <div className="col-lg-6 col-12 bg-danger">
                                                <LazyImage src={member.photo} alt={member.name} className="img-fluid mb-3 w-100" />
                                            </div>
